...
@interface YLScrollView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageName =self.images[index];
    return cell;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(YLScrollView:didSelectItemAtIndex:)]) {
        
        [self.delegate YLScrollView:self didSelectItemAtIndex:(int)indexPath.item % self.images.count];
    }
